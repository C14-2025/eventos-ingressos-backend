...
describe('SellTicketController', (): void => {
  ...
  it('Should be able to sell ticket', async (): Promise<void> => {
    const response = await request(app.server).post('/events/sell-ticket').send({
